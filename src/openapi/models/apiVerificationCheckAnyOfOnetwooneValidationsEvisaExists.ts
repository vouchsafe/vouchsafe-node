 ...
 */
import type { ApiVerificationCheckAnyOfOnetwooneValidationsEvisaExistsStatus } from './apiVerificationCheckAnyOfOnetwooneValidationsEvisaExistsStatus';

export type ApiVerificationCheckAnyOfOnetwooneValidationsEvisaExists = {
  status: ApiVerificationCheckAnyOfOnetwooneValidationsEvisaExistsStatus;
  [key: string]: unknown;
};
