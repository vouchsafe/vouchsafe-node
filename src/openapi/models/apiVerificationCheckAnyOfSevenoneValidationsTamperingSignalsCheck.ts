 ...
 */
import type { ApiVerificationCheckAnyOfSevenoneValidationsTamperingSignalsCheckStatus } from './apiVerificationCheckAnyOfSevenoneValidationsTamperingSignalsCheckStatus';

export type ApiVerificationCheckAnyOfSevenoneValidationsTamperingSignalsCheck = {
  status: ApiVerificationCheckAnyOfSevenoneValidationsTamperingSignalsCheckStatus;
  [key: string]: unknown;
};
