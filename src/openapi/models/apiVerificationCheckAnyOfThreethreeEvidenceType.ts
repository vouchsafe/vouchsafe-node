...
export type ApiVerificationCheckAnyOfThreethreeEvidenceType = 'unfamiliar_photo_id' | 'passport' | 'driving_licence' | 'young_scot' | 'national_entitlement_card' | 'national_id' | 'citizen_card';