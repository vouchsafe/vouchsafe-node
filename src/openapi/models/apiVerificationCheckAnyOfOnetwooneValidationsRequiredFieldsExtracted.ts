 ...
 */
import type { ApiVerificationCheckAnyOfOnetwooneValidationsRequiredFieldsExtractedStatus } from './apiVerificationCheckAnyOfOnetwooneValidationsRequiredFieldsExtractedStatus';

export type ApiVerificationCheckAnyOfOnetwooneValidationsRequiredFieldsExtracted = {
  status: ApiVerificationCheckAnyOfOnetwooneValidationsRequiredFieldsExtractedStatus;
  [key: string]: unknown;
};
