 ...
 */
import type { DocumentDimensionsErrorCode } from './documentDimensionsErrorCode';
import type { ScoreCheckDocumentDimensionsErrorCodeAnyOfThreeStatus } from './scoreCheckDocumentDimensionsErrorCodeAnyOfThreeStatus';

export type ScoreCheckDocumentDimensionsErrorCodeAnyOfThree = {
  failed_reasons: DocumentDimensionsErrorCode[];
  /** @nullable */
  score: number | null;
  status: ScoreCheckDocumentDimensionsErrorCodeAnyOfThreeStatus;
};
