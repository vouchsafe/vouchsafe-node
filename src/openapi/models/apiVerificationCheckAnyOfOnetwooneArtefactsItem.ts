 ...
 */
import type { ApiVerificationCheckAnyOfOnetwooneArtefactsItemRole } from './apiVerificationCheckAnyOfOnetwooneArtefactsItemRole';

export type ApiVerificationCheckAnyOfOnetwooneArtefactsItem = {
  key: string;
  role: ApiVerificationCheckAnyOfOnetwooneArtefactsItemRole;
};
