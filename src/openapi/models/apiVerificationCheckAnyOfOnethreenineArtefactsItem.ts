 ...
 */
import type { ApiVerificationCheckAnyOfOnethreenineArtefactsItemRole } from './apiVerificationCheckAnyOfOnethreenineArtefactsItemRole';

export type ApiVerificationCheckAnyOfOnethreenineArtefactsItem = {
  key: string;
  role: ApiVerificationCheckAnyOfOnethreenineArtefactsItemRole;
};
