 ...
 */
import type { FraudBlocklistAlertResponseMatchedOnItem } from './fraudBlocklistAlertResponseMatchedOnItem';
import type { FraudBlocklistAlertResponseSource } from './fraudBlocklistAlertResponseSource';

export interface FraudBlocklistAlertResponse {
  id: string;
  created_at: string;
  /** @nullable */
  acknowledged_at: string | null;
  source: FraudBlocklistAlertResponseSource;
  matched_on: FraudBlocklistAlertResponseMatchedOnItem[];
}
