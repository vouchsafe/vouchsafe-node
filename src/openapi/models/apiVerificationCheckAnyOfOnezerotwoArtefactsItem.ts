 ...
 */
import type { ApiVerificationCheckAnyOfOnezerotwoArtefactsItemRole } from './apiVerificationCheckAnyOfOnezerotwoArtefactsItemRole';

export type ApiVerificationCheckAnyOfOnezerotwoArtefactsItem = {
  key: string;
  role: ApiVerificationCheckAnyOfOnezerotwoArtefactsItemRole;
};
