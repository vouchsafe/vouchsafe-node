 ...
 */
import type { ApiVerificationCheckAnyOfOnetwooneValidationsFaceMatchStatus } from './apiVerificationCheckAnyOfOnetwooneValidationsFaceMatchStatus';

export type ApiVerificationCheckAnyOfOnetwooneValidationsFaceMatch = {
  score: number;
  status: ApiVerificationCheckAnyOfOnetwooneValidationsFaceMatchStatus;
  [key: string]: unknown;
};
