 ...
 */
import type { NecValidationApiFaceMatchStatus } from './necValidationApiFaceMatchStatus';

/**
 * Whether the photo ID face matches the video selfie (with score).
 */
export type NecValidationApiFaceMatch = {
  /** @nullable */
  score: number | null;
  status: NecValidationApiFaceMatchStatus;
};
