 ...
 */
import type { FailedReasonSAMPLEDOCUMENTNUMBERDETECTED } from './failedReasonSAMPLEDOCUMENTNUMBERDETECTED';
import type { FailedReasonSAMPLEMRZCODEDETECTED } from './failedReasonSAMPLEMRZCODEDETECTED';
import type { FailedReasonSAMPLENAMEDETECTED } from './failedReasonSAMPLENAMEDETECTED';
import type { FailedReasonWATERMARKTEXTDETECTED } from './failedReasonWATERMARKTEXTDETECTED';

export type SpecimenErrorCode = FailedReasonWATERMARKTEXTDETECTED | FailedReasonSAMPLEDOCUMENTNUMBERDETECTED | FailedReasonSAMPLENAMEDETECTED | FailedReasonSAMPLEMRZCODEDETECTED;
