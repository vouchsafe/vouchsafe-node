 ...
 */
import type { NationalIdValidationApiDocumentBordersDetected } from './nationalIdValidationApiDocumentBordersDetected';
import type { NationalIdValidationApiFaceMatch } from './nationalIdValidationApiFaceMatch';
import type { ValidationOutcomeApi } from './validationOutcomeApi';

export interface NationalIdValidationApi {
  ...
  document_borders_detected: NationalIdValidationApiDocumentBordersDetected;
  /** Whether the photo ID face matches the video selfie (with score). */
  face_match?: NationalIdValidationApiFaceMatch;
