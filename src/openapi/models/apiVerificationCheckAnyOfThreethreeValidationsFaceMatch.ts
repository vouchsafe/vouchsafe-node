 ...
 */
import type { ApiVerificationCheckAnyOfThreethreeValidationsFaceMatchStatus } from './apiVerificationCheckAnyOfThreethreeValidationsFaceMatchStatus';

export type ApiVerificationCheckAnyOfThreethreeValidationsFaceMatch = {
  score: number;
  status: ApiVerificationCheckAnyOfThreethreeValidationsFaceMatchStatus;
  [key: string]: unknown;
};
