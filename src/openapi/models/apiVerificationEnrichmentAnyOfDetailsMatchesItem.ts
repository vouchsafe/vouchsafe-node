 ...
 */
import type { ApiVerificationEnrichmentAnyOfDetailsMatchesItemProperties } from './apiVerificationEnrichmentAnyOfDetailsMatchesItemProperties';

export type ApiVerificationEnrichmentAnyOfDetailsMatchesItem = {
  properties: ApiVerificationEnrichmentAnyOfDetailsMatchesItemProperties;
  last_seen?: string;
  first_seen?: string;
  score: number;
  caption: string;
