 ...
 */
import type { ApiVerificationCheckAnyOfOnezerotwoValidationsNonZeroBalanceStatus } from './apiVerificationCheckAnyOfOnezerotwoValidationsNonZeroBalanceStatus';

export type ApiVerificationCheckAnyOfOnezerotwoValidationsNonZeroBalance = {
  status: ApiVerificationCheckAnyOfOnezerotwoValidationsNonZeroBalanceStatus;
  [key: string]: unknown;
};
