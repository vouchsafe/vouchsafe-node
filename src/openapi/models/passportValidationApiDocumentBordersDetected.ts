 ...
 */
import type { PassportValidationApiDocumentBordersDetectedStatus } from './passportValidationApiDocumentBordersDetectedStatus';

/**
 * Whether the correct document dimensions were detected (with score).
 */
export type PassportValidationApiDocumentBordersDetected = {
  /** @nullable */
  score: number | null;
  status: PassportValidationApiDocumentBordersDetectedStatus;
};
