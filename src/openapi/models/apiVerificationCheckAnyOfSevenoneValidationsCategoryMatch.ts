 ...
 */
import type { ApiVerificationCheckAnyOfSevenoneValidationsCategoryMatchStatus } from './apiVerificationCheckAnyOfSevenoneValidationsCategoryMatchStatus';

export type ApiVerificationCheckAnyOfSevenoneValidationsCategoryMatch = {
  status: ApiVerificationCheckAnyOfSevenoneValidationsCategoryMatchStatus;
  [key: string]: unknown;
};
