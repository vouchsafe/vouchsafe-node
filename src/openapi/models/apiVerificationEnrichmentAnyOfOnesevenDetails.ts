 ...
 */
import type { ApiVerificationEnrichmentAnyOfOnesevenDetailsValidations } from './apiVerificationEnrichmentAnyOfOnesevenDetailsValidations';

export type ApiVerificationEnrichmentAnyOfOnesevenDetails = {
  validations: ApiVerificationEnrichmentAnyOfOnesevenDetailsValidations;
};
