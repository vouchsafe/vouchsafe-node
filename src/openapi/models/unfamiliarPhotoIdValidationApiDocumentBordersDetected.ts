 ...
 */
import type { UnfamiliarPhotoIdValidationApiDocumentBordersDetectedStatus } from './unfamiliarPhotoIdValidationApiDocumentBordersDetectedStatus';

/**
 * Whether the correct document dimensions were detected (with score).
 */
export type UnfamiliarPhotoIdValidationApiDocumentBordersDetected = {
  /** @nullable */
  score: number | null;
  status: UnfamiliarPhotoIdValidationApiDocumentBordersDetectedStatus;
};
