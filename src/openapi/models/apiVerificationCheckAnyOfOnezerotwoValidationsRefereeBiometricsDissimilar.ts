 ...
 */
import type { ApiVerificationCheckAnyOfOnezerotwoValidationsRefereeBiometricsDissimilarStatus } from './apiVerificationCheckAnyOfOnezerotwoValidationsRefereeBiometricsDissimilarStatus';

export type ApiVerificationCheckAnyOfOnezerotwoValidationsRefereeBiometricsDissimilar = {
  status: ApiVerificationCheckAnyOfOnezerotwoValidationsRefereeBiometricsDissimilarStatus;
  [key: string]: unknown;
};
