 ...
 */
import type { ApiVerificationCheckAnyOfValidationsLivenessCheckStatus } from './apiVerificationCheckAnyOfValidationsLivenessCheckStatus';

export type ApiVerificationCheckAnyOfValidationsLivenessCheck = {
  score: number;
  status: ApiVerificationCheckAnyOfValidationsLivenessCheckStatus;
  [key: string]: unknown;
};
