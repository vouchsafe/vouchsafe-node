 ...
 */
import type { ApiVerificationCheckAnyOfOnesevenOutcome } from './apiVerificationCheckAnyOfOnesevenOutcome';
import type { ApiVerificationCheckAnyOfOnesevenStep } from './apiVerificationCheckAnyOfOnesevenStep';
import type { ApiVerificationCheckAnyOfOnesevenValidations } from './apiVerificationCheckAnyOfOnesevenValidations';

export type ApiVerificationCheckAnyOfOneseven = {
  validations: ApiVerificationCheckAnyOfOnesevenValidations;
  created_at?: string;
  total_attempts?: number;
  outcome: ApiVerificationCheckAnyOfOnesevenOutcome;
  step: ApiVerificationCheckAnyOfOnesevenStep;
};
