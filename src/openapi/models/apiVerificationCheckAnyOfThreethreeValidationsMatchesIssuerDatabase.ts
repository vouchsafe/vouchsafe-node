 ...
 */
import type { ApiVerificationCheckAnyOfThreethreeValidationsMatchesIssuerDatabaseStatus } from './apiVerificationCheckAnyOfThreethreeValidationsMatchesIssuerDatabaseStatus';

export type ApiVerificationCheckAnyOfThreethreeValidationsMatchesIssuerDatabase = {
  status: ApiVerificationCheckAnyOfThreethreeValidationsMatchesIssuerDatabaseStatus;
  [key: string]: unknown;
};
