 ...
 */
import type { UnfamiliarPhotoIdValidationApiFaceMatchStatus } from './unfamiliarPhotoIdValidationApiFaceMatchStatus';

/**
 * Whether the photo ID face matches the video selfie (with score).
 */
export type UnfamiliarPhotoIdValidationApiFaceMatch = {
  /** @nullable */
  score: number | null;
  status: UnfamiliarPhotoIdValidationApiFaceMatchStatus;
};
