 ...
 */
import type { EvisaValidationsApiFaceMatchStatus } from './evisaValidationsApiFaceMatchStatus';

/**
 * Whether the eVisa photo matches the video selfie (with score).
 */
export type EvisaValidationsApiFaceMatch = {
  /** @nullable */
  score: number | null;
  status: EvisaValidationsApiFaceMatchStatus;
};
