 ...
 */
import type { FailPASSCardFailedReasonStatus } from './failPASSCardFailedReasonStatus';
import type { PASSCardFailedReason } from './pASSCardFailedReason';

export interface FailPASSCardFailedReason {
  status: FailPASSCardFailedReasonStatus;
