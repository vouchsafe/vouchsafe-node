 ...
 */
import type { ApiVerificationCheckAnyOfThreethreeValidationsNotSampleOrInternalUseStatus } from './apiVerificationCheckAnyOfThreethreeValidationsNotSampleOrInternalUseStatus';

export type ApiVerificationCheckAnyOfThreethreeValidationsNotSampleOrInternalUse = {
  status: ApiVerificationCheckAnyOfThreethreeValidationsNotSampleOrInternalUseStatus;
  [key: string]: unknown;
};
