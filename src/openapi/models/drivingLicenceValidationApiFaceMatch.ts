 ...
 */
import type { DrivingLicenceValidationApiFaceMatchStatus } from './drivingLicenceValidationApiFaceMatchStatus';

/**
 * Whether the photo ID face matches the video selfie (with score).
 */
export type DrivingLicenceValidationApiFaceMatch = {
  /** @nullable */
  score: number | null;
  status: DrivingLicenceValidationApiFaceMatchStatus;
};
