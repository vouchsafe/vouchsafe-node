 ...
 */
import type { ApiVerificationEnrichmentAnyOfOnesevenCheck } from './apiVerificationEnrichmentAnyOfOnesevenCheck';
import type { ApiVerificationEnrichmentAnyOfOnesevenDetails } from './apiVerificationEnrichmentAnyOfOnesevenDetails';
import type { ApiVerificationEnrichmentAnyOfOnesevenOutcome } from './apiVerificationEnrichmentAnyOfOnesevenOutcome';

export type ApiVerificationEnrichmentAnyOfOneseven = {
  details: ApiVerificationEnrichmentAnyOfOnesevenDetails;
  outcome: ApiVerificationEnrichmentAnyOfOnesevenOutcome;
  check: ApiVerificationEnrichmentAnyOfOnesevenCheck;
};
