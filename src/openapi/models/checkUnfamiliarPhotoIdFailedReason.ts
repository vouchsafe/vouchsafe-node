 ...
 */
import type { FailUnfamiliarPhotoIdFailedReason } from './failUnfamiliarPhotoIdFailedReason';
import type { Pass } from './pass';

export type CheckUnfamiliarPhotoIdFailedReason = Pass | FailUnfamiliarPhotoIdFailedReason;
