 ...
 */
import type { ApiVerificationEnrichmentAnyOfOnesevenDetailsValidationsNotDisposableEmailStatus } from './apiVerificationEnrichmentAnyOfOnesevenDetailsValidationsNotDisposableEmailStatus';

export type ApiVerificationEnrichmentAnyOfOnesevenDetailsValidationsNotDisposableEmail = {
  status: ApiVerificationEnrichmentAnyOfOnesevenDetailsValidationsNotDisposableEmailStatus;
  [key: string]: unknown;
};
