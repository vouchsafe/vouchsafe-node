 ...
 */
import type { EvisaConditionsFailed } from './evisaConditionsFailed';
import type { EvisaConditionsSuccess } from './evisaConditionsSuccess';

export type EvisaConditionsApiResponse = EvisaConditionsSuccess | EvisaConditionsFailed;
