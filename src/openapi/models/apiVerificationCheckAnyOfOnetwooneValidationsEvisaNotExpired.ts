 ...
 */
import type { ApiVerificationCheckAnyOfOnetwooneValidationsEvisaNotExpiredStatus } from './apiVerificationCheckAnyOfOnetwooneValidationsEvisaNotExpiredStatus';

export type ApiVerificationCheckAnyOfOnetwooneValidationsEvisaNotExpired = {
  status: ApiVerificationCheckAnyOfOnetwooneValidationsEvisaNotExpiredStatus;
  [key: string]: unknown;
};
