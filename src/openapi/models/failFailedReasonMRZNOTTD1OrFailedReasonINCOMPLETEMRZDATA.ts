 ...
 */
import type { FailFailedReasonMRZNOTTD1OrFailedReasonINCOMPLETEMRZDATAFailedReasonsItem } from './failFailedReasonMRZNOTTD1OrFailedReasonINCOMPLETEMRZDATAFailedReasonsItem';
import type { FailFailedReasonMRZNOTTD1OrFailedReasonINCOMPLETEMRZDATAStatus } from './failFailedReasonMRZNOTTD1OrFailedReasonINCOMPLETEMRZDATAStatus';

export interface FailFailedReasonMRZNOTTD1OrFailedReasonINCOMPLETEMRZDATA {
  status: FailFailedReasonMRZNOTTD1OrFailedReasonINCOMPLETEMRZDATAStatus;
  failed_reasons: FailFailedReasonMRZNOTTD1OrFailedReasonINCOMPLETEMRZDATAFailedReasonsItem[];
}
