 ...
 */
import type { VideoSelfieCheckApiValidationsLivenessCheckStatus } from './videoSelfieCheckApiValidationsLivenessCheckStatus';

export type VideoSelfieCheckApiValidationsLivenessCheck = {
  /**
  ...
  status: VideoSelfieCheckApiValidationsLivenessCheckStatus;
};
