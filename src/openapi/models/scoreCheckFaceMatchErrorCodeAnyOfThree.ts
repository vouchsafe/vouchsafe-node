 ...
 */
import type { FaceMatchErrorCode } from './faceMatchErrorCode';
import type { ScoreCheckFaceMatchErrorCodeAnyOfThreeStatus } from './scoreCheckFaceMatchErrorCodeAnyOfThreeStatus';

export type ScoreCheckFaceMatchErrorCodeAnyOfThree = {
  failed_reasons: FaceMatchErrorCode[];
  /** @nullable */
  score: number | null;
  status: ScoreCheckFaceMatchErrorCodeAnyOfThreeStatus;
};
