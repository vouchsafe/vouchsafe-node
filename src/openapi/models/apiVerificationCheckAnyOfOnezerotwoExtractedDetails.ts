 ...
 */
import type { ApiVerificationCheckAnyOfOnezerotwoExtractedDetailsAccountType } from './apiVerificationCheckAnyOfOnezerotwoExtractedDetailsAccountType';

export type ApiVerificationCheckAnyOfOnezerotwoExtractedDetails = {
  transaction_data: unknown;
  account_type: ApiVerificationCheckAnyOfOnezerotwoExtractedDetailsAccountType;
  bank_name: string;
  postcode?: string;
