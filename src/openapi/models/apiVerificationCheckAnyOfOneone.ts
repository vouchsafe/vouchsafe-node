 ...
 */
import type { ApiVerificationCheckAnyOfOneoneOutcome } from './apiVerificationCheckAnyOfOneoneOutcome';
import type { ApiVerificationCheckAnyOfOneoneStep } from './apiVerificationCheckAnyOfOneoneStep';
import type { ApiVerificationCheckAnyOfOneoneValidations } from './apiVerificationCheckAnyOfOneoneValidations';

export type ApiVerificationCheckAnyOfOneone = {
  validations: ApiVerificationCheckAnyOfOneoneValidations;
  created_at?: string;
  total_attempts?: number;
  outcome: ApiVerificationCheckAnyOfOneoneOutcome;
  step: ApiVerificationCheckAnyOfOneoneStep;
};
