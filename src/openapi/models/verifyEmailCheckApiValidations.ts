 ...
 */
import type { VerifyEmailCheckApiValidationsEmailVerified } from './verifyEmailCheckApiValidationsEmailVerified';

/**
 * Validations performed on the email address.
 */
export type VerifyEmailCheckApiValidations = {
  /** Present only when the email address has been verified.
Otherwise undefined. */
  email_verified?: VerifyEmailCheckApiValidationsEmailVerified;
};
