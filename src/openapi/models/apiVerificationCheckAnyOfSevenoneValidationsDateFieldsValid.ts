 ...
 */
import type { ApiVerificationCheckAnyOfSevenoneValidationsDateFieldsValidStatus } from './apiVerificationCheckAnyOfSevenoneValidationsDateFieldsValidStatus';

export type ApiVerificationCheckAnyOfSevenoneValidationsDateFieldsValid = {
  status: ApiVerificationCheckAnyOfSevenoneValidationsDateFieldsValidStatus;
  [key: string]: unknown;
};
