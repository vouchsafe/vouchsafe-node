 ...
 */
import type { ApiVerificationCheckAnyOfSevenoneValidationsDocumentCompleteAndLegibleStatus } from './apiVerificationCheckAnyOfSevenoneValidationsDocumentCompleteAndLegibleStatus';

export type ApiVerificationCheckAnyOfSevenoneValidationsDocumentCompleteAndLegible = {
  status: ApiVerificationCheckAnyOfSevenoneValidationsDocumentCompleteAndLegibleStatus;
  [key: string]: unknown;
};
