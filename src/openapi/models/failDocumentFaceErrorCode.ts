 ...
 */
import type { FailDocumentFaceErrorCodeStatus } from './failDocumentFaceErrorCodeStatus';
import type { FailedReasonNOFACEONDOCUMENT } from './failedReasonNOFACEONDOCUMENT';

export interface FailDocumentFaceErrorCode {
  status: FailDocumentFaceErrorCodeStatus;
  failed_reasons: FailedReasonNOFACEONDOCUMENT[];
}
