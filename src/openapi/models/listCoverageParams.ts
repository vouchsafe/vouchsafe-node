...
export type ListCoverageParams = {
/**
 * Two-letter country code (ISO 3166-1 alpha-2) to filter by, e.g. `GB`. Case insensitive. Omit to see worldwide coverage.
 */
country_code?: string;
/**
 * Evidence type to filter by. Omit to return all types.
 */
type?: CoverageType;
};
