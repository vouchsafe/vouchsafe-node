 ...
 */
import type { ApiVerificationCheckAnyOfThreethreeValidationsRequiredFieldsExtractedStatus } from './apiVerificationCheckAnyOfThreethreeValidationsRequiredFieldsExtractedStatus';

export type ApiVerificationCheckAnyOfThreethreeValidationsRequiredFieldsExtracted = {
  status: ApiVerificationCheckAnyOfThreethreeValidationsRequiredFieldsExtractedStatus;
  [key: string]: unknown;
};
