 ...
 */
import type { ApiVerificationCheckAnyOfThreethreeValidationsIssuingCountryAllowedStatus } from './apiVerificationCheckAnyOfThreethreeValidationsIssuingCountryAllowedStatus';

export type ApiVerificationCheckAnyOfThreethreeValidationsIssuingCountryAllowed = {
  status: ApiVerificationCheckAnyOfThreethreeValidationsIssuingCountryAllowedStatus;
  [key: string]: unknown;
};
