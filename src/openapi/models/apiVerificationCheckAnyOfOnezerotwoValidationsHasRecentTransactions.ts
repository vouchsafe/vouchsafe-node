 ...
 */
import type { ApiVerificationCheckAnyOfOnezerotwoValidationsHasRecentTransactionsStatus } from './apiVerificationCheckAnyOfOnezerotwoValidationsHasRecentTransactionsStatus';

export type ApiVerificationCheckAnyOfOnezerotwoValidationsHasRecentTransactions = {
  status: ApiVerificationCheckAnyOfOnezerotwoValidationsHasRecentTransactionsStatus;
  [key: string]: unknown;
};
