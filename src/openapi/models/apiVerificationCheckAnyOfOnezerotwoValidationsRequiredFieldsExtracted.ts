 ...
 */
import type { ApiVerificationCheckAnyOfOnezerotwoValidationsRequiredFieldsExtractedStatus } from './apiVerificationCheckAnyOfOnezerotwoValidationsRequiredFieldsExtractedStatus';

export type ApiVerificationCheckAnyOfOnezerotwoValidationsRequiredFieldsExtracted = {
  status: ApiVerificationCheckAnyOfOnezerotwoValidationsRequiredFieldsExtractedStatus;
  [key: string]: unknown;
};
