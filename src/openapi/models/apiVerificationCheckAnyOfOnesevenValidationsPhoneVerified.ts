 ...
 */
import type { ApiVerificationCheckAnyOfOnesevenValidationsPhoneVerifiedStatus } from './apiVerificationCheckAnyOfOnesevenValidationsPhoneVerifiedStatus';

export type ApiVerificationCheckAnyOfOnesevenValidationsPhoneVerified = {
  verified_at: string;
  status: ApiVerificationCheckAnyOfOnesevenValidationsPhoneVerifiedStatus;
  [key: string]: unknown;
};
