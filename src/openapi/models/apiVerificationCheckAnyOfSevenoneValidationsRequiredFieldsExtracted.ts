 ...
 */
import type { ApiVerificationCheckAnyOfSevenoneValidationsRequiredFieldsExtractedStatus } from './apiVerificationCheckAnyOfSevenoneValidationsRequiredFieldsExtractedStatus';

export type ApiVerificationCheckAnyOfSevenoneValidationsRequiredFieldsExtracted = {
  status: ApiVerificationCheckAnyOfSevenoneValidationsRequiredFieldsExtractedStatus;
  [key: string]: unknown;
};
