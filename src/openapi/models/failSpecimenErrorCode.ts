 ...
 */
import type { FailSpecimenErrorCodeStatus } from './failSpecimenErrorCodeStatus';
import type { SpecimenErrorCode } from './specimenErrorCode';

export interface FailSpecimenErrorCode {
  status: FailSpecimenErrorCodeStatus;
  failed_reasons: SpecimenErrorCode[];
}
