 ...
 */
import type { ApiVerificationCheckAnyOfTwothreeValidationsRefereeConfirmedPhotoStatus } from './apiVerificationCheckAnyOfTwothreeValidationsRefereeConfirmedPhotoStatus';

export type ApiVerificationCheckAnyOfTwothreeValidationsRefereeConfirmedPhoto = {
  status: ApiVerificationCheckAnyOfTwothreeValidationsRefereeConfirmedPhotoStatus;
  [key: string]: unknown;
};
