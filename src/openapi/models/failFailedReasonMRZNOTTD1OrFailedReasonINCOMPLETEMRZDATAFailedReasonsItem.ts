...
import type { FailedReasonMRZNOTTD1 } from './failedReasonMRZNOTTD1';

export type FailFailedReasonMRZNOTTD1OrFailedReasonINCOMPLETEMRZDATAFailedReasonsItem = FailedReasonMRZNOTTD1 | FailedReasonINCOMPLETEMRZDATA;
