 ...
 */
import type { ApiVerificationCheckAnyOfThreethreeValidationsCompoundIdentifiersMatchStatus } from './apiVerificationCheckAnyOfThreethreeValidationsCompoundIdentifiersMatchStatus';

export type ApiVerificationCheckAnyOfThreethreeValidationsCompoundIdentifiersMatch = {
  status: ApiVerificationCheckAnyOfThreethreeValidationsCompoundIdentifiersMatchStatus;
  [key: string]: unknown;
};
