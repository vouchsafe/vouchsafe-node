 ...
 */
import type { ApiVerificationCheckAnyOfThreethreeValidationsDocumentBordersDetectedStatus } from './apiVerificationCheckAnyOfThreethreeValidationsDocumentBordersDetectedStatus';

export type ApiVerificationCheckAnyOfThreethreeValidationsDocumentBordersDetected = {
  score: number;
  status: ApiVerificationCheckAnyOfThreethreeValidationsDocumentBordersDetectedStatus;
  [key: string]: unknown;
};
