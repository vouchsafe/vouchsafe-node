 ...
 */
import type { ApiVerificationCheckAnyOfSevenoneArtefactsItemRole } from './apiVerificationCheckAnyOfSevenoneArtefactsItemRole';

export type ApiVerificationCheckAnyOfSevenoneArtefactsItem = {
  key: string;
  role: ApiVerificationCheckAnyOfSevenoneArtefactsItemRole;
};
