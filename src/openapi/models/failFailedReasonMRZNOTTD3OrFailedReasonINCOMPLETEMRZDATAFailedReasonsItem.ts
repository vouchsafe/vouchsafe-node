...
import type { FailedReasonMRZNOTTD3 } from './failedReasonMRZNOTTD3';

export type FailFailedReasonMRZNOTTD3OrFailedReasonINCOMPLETEMRZDATAFailedReasonsItem = FailedReasonMRZNOTTD3 | FailedReasonINCOMPLETEMRZDATA;
