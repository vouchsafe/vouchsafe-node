 ...
 */
import type { NecValidationApiDocumentBordersDetectedStatus } from './necValidationApiDocumentBordersDetectedStatus';

/**
 * Whether the correct document dimensions were detected (with score).
 */
export type NecValidationApiDocumentBordersDetected = {
  /** @nullable */
  score: number | null;
  status: NecValidationApiDocumentBordersDetectedStatus;
};
