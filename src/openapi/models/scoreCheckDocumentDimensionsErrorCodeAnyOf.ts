 ...
 */
import type { ScoreCheckDocumentDimensionsErrorCodeAnyOfStatus } from './scoreCheckDocumentDimensionsErrorCodeAnyOfStatus';

export type ScoreCheckDocumentDimensionsErrorCodeAnyOf = {
  score: number;
  status: ScoreCheckDocumentDimensionsErrorCodeAnyOfStatus;
};
