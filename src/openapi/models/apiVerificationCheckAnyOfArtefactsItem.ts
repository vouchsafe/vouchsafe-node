 ...
 */
import type { ApiVerificationCheckAnyOfArtefactsItemRole } from './apiVerificationCheckAnyOfArtefactsItemRole';

export type ApiVerificationCheckAnyOfArtefactsItem = {
  key: string;
  role: ApiVerificationCheckAnyOfArtefactsItemRole;
};
