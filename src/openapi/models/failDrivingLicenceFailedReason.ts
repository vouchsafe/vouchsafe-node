 ...
 */
import type { DrivingLicenceFailedReason } from './drivingLicenceFailedReason';
import type { FailDrivingLicenceFailedReasonStatus } from './failDrivingLicenceFailedReasonStatus';

export interface FailDrivingLicenceFailedReason {
  status: FailDrivingLicenceFailedReasonStatus;
  failed_reasons: DrivingLicenceFailedReason[];
}
