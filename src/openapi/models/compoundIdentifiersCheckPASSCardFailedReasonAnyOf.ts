 ...
 */
import type { CompoundIdentifiersCheckPASSCardFailedReasonAnyOfStatus } from './compoundIdentifiersCheckPASSCardFailedReasonAnyOfStatus';

export type CompoundIdentifiersCheckPASSCardFailedReasonAnyOf = {
  status: CompoundIdentifiersCheckPASSCardFailedReasonAnyOfStatus;
};
