 ...
 */
import type { ApiVerificationCheckAnyOfThreethreeValidationsIdentifierFormatValidStatus } from './apiVerificationCheckAnyOfThreethreeValidationsIdentifierFormatValidStatus';

export type ApiVerificationCheckAnyOfThreethreeValidationsIdentifierFormatValid = {
  status: ApiVerificationCheckAnyOfThreethreeValidationsIdentifierFormatValidStatus;
  [key: string]: unknown;
};
