 ...
 */
import type { ApiVerificationCheckAnyOfSevenoneValidationsRefereeBiometricsDissimilarStatus } from './apiVerificationCheckAnyOfSevenoneValidationsRefereeBiometricsDissimilarStatus';

export type ApiVerificationCheckAnyOfSevenoneValidationsRefereeBiometricsDissimilar = {
  status: ApiVerificationCheckAnyOfSevenoneValidationsRefereeBiometricsDissimilarStatus;
  [key: string]: unknown;
};
