 ...
 */
import type { ApiVerificationEnrichmentAnyOfCheck } from './apiVerificationEnrichmentAnyOfCheck';
import type { ApiVerificationEnrichmentAnyOfDetails } from './apiVerificationEnrichmentAnyOfDetails';
import type { ApiVerificationEnrichmentAnyOfOutcome } from './apiVerificationEnrichmentAnyOfOutcome';

export type ApiVerificationEnrichmentAnyOf = {
  details: ApiVerificationEnrichmentAnyOfDetails;
  outcome: ApiVerificationEnrichmentAnyOfOutcome;
  check: ApiVerificationEnrichmentAnyOfCheck;
};
