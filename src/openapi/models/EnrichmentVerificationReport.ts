 ...
 */
import type { EnrichmentVerificationReportState } from './enrichmentVerificationReportState';
import type { RecordStringEnrichmentCheckResult } from './recordStringEnrichmentCheckResult';

export interface EnrichmentVerificationReport {
  checks: RecordStringEnrichmentCheckResult;
  state: EnrichmentVerificationReportState;
}
