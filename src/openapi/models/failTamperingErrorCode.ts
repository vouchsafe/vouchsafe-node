 ...
 */
import type { FailTamperingErrorCodeStatus } from './failTamperingErrorCodeStatus';
import type { TamperingErrorCode } from './tamperingErrorCode';

export interface FailTamperingErrorCode {
  status: FailTamperingErrorCodeStatus;
  failed_reasons: TamperingErrorCode[];
}
