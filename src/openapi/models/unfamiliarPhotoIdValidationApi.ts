 ...
 */
import type { UnfamiliarPhotoIdValidationApiDocumentBordersDetected } from './unfamiliarPhotoIdValidationApiDocumentBordersDetected';
import type { UnfamiliarPhotoIdValidationApiFaceMatch } from './unfamiliarPhotoIdValidationApiFaceMatch';
import type { ValidationOutcomeApi } from './validationOutcomeApi';

export interface UnfamiliarPhotoIdValidationApi {
  ...
  document_borders_detected: UnfamiliarPhotoIdValidationApiDocumentBordersDetected;
  /** Whether the photo ID face matches the video selfie (with score). */
  face_match?: UnfamiliarPhotoIdValidationApiFaceMatch;
