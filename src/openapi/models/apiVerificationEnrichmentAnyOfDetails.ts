 ...
 */
import type { ApiVerificationEnrichmentAnyOfDetailsMatchesItem } from './apiVerificationEnrichmentAnyOfDetailsMatchesItem';

export type ApiVerificationEnrichmentAnyOfDetails = {
  matches: ApiVerificationEnrichmentAnyOfDetailsMatchesItem[];
};
