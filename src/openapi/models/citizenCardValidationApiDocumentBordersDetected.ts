 ...
 */
import type { CitizenCardValidationApiDocumentBordersDetectedStatus } from './citizenCardValidationApiDocumentBordersDetectedStatus';

/**
 * Whether the correct document dimensions were detected (with score).
 */
export type CitizenCardValidationApiDocumentBordersDetected = {
  /** @nullable */
  score: number | null;
  status: CitizenCardValidationApiDocumentBordersDetectedStatus;
};
