 ...
 */
import type { ApiVerificationCheckAnyOfSevenoneValidationsDocumentAgeValidStatus } from './apiVerificationCheckAnyOfSevenoneValidationsDocumentAgeValidStatus';

export type ApiVerificationCheckAnyOfSevenoneValidationsDocumentAgeValid = {
  status: ApiVerificationCheckAnyOfSevenoneValidationsDocumentAgeValidStatus;
  [key: string]: unknown;
};
