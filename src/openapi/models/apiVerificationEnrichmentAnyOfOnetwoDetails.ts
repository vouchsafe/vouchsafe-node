 ...
 */
import type { ApiVerificationEnrichmentAnyOfOnetwoDetailsSignals } from './apiVerificationEnrichmentAnyOfOnetwoDetailsSignals';

export type ApiVerificationEnrichmentAnyOfOnetwoDetails = {
  signals: ApiVerificationEnrichmentAnyOfOnetwoDetailsSignals;
  score: number;
};
