 ...
 */
import type { ApiVerificationCheckAnyOfThreethreeValidationsHasNotExpiredStatus } from './apiVerificationCheckAnyOfThreethreeValidationsHasNotExpiredStatus';

export type ApiVerificationCheckAnyOfThreethreeValidationsHasNotExpired = {
  status: ApiVerificationCheckAnyOfThreethreeValidationsHasNotExpiredStatus;
  [key: string]: unknown;
};
