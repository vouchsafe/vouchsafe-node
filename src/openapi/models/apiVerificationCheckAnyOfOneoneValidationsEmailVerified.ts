 ...
 */
import type { ApiVerificationCheckAnyOfOneoneValidationsEmailVerifiedStatus } from './apiVerificationCheckAnyOfOneoneValidationsEmailVerifiedStatus';

export type ApiVerificationCheckAnyOfOneoneValidationsEmailVerified = {
  verified_at: string;
  status: ApiVerificationCheckAnyOfOneoneValidationsEmailVerifiedStatus;
  [key: string]: unknown;
};
