 ...
 */
import type { ApiVerificationCheckAnyOfThreethreeValidationsIcaoFormatValidStatus } from './apiVerificationCheckAnyOfThreethreeValidationsIcaoFormatValidStatus';

export type ApiVerificationCheckAnyOfThreethreeValidationsIcaoFormatValid = {
  status: ApiVerificationCheckAnyOfThreethreeValidationsIcaoFormatValidStatus;
  [key: string]: unknown;
};
