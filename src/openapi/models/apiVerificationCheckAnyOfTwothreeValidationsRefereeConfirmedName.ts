 ...
 */
import type { ApiVerificationCheckAnyOfTwothreeValidationsRefereeConfirmedNameStatus } from './apiVerificationCheckAnyOfTwothreeValidationsRefereeConfirmedNameStatus';

export type ApiVerificationCheckAnyOfTwothreeValidationsRefereeConfirmedName = {
  status: ApiVerificationCheckAnyOfTwothreeValidationsRefereeConfirmedNameStatus;
  [key: string]: unknown;
};
