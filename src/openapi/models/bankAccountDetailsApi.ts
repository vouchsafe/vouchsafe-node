 ...
 */
import type { BankAccountDetailsApiAccountType } from './bankAccountDetailsApiAccountType';
import type { BankAccountDetailsApiTransactionData } from './bankAccountDetailsApiTransactionData';

export interface BankAccountDetailsApi {
  /**
   ...
   * @nullable
   */
  account_type: BankAccountDetailsApiAccountType;
  /** Transaction summary and metadata, if available. Otherwise null. */
  transaction_data: BankAccountDetailsApiTransactionData;
}
