 ...
 */
import type { ApiVerificationCheckAnyOfThreethreeArtefactsItemRole } from './apiVerificationCheckAnyOfThreethreeArtefactsItemRole';

export type ApiVerificationCheckAnyOfThreethreeArtefactsItem = {
  key: string;
  role: ApiVerificationCheckAnyOfThreethreeArtefactsItemRole;
};
