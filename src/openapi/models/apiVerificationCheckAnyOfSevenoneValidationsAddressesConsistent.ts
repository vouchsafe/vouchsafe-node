 ...
 */
import type { ApiVerificationCheckAnyOfSevenoneValidationsAddressesConsistentStatus } from './apiVerificationCheckAnyOfSevenoneValidationsAddressesConsistentStatus';

export type ApiVerificationCheckAnyOfSevenoneValidationsAddressesConsistent = {
  status: ApiVerificationCheckAnyOfSevenoneValidationsAddressesConsistentStatus;
  [key: string]: unknown;
};
