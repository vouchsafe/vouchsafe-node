 ...
 */
import type { VerifyPhoneNumberCheckApiValidationsPhoneVerifiedStatus } from './verifyPhoneNumberCheckApiValidationsPhoneVerifiedStatus';

/**
 * Present only when the phone number has been verified.
Otherwise undefined.
 */
export type VerifyPhoneNumberCheckApiValidationsPhoneVerified = {
  /** ISO 8601 timestamp for when the phone number was verified. */
  verified_at: string;
  status: VerifyPhoneNumberCheckApiValidationsPhoneVerifiedStatus;
};
