 ...
 */
import type { FailDrivingLicenceFailedReason } from './failDrivingLicenceFailedReason';
import type { Pass } from './pass';

export type CheckDrivingLicenceFailedReason = Pass | FailDrivingLicenceFailedReason;
