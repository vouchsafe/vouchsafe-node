...
export type ImmigrationStatusEvisaNotExpiredFailedReason = 'SHARE_CODE_ERROR' | 'INCORRECT_DETAILS' | 'EVISA_NOT_YET_VALID' | 'EXPIRY_DATE_PASSED' | 'UNRECOGNISED_INDEFINITE_STATUS';