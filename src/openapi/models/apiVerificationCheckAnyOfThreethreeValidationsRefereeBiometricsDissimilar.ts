 ...
 */
import type { ApiVerificationCheckAnyOfThreethreeValidationsRefereeBiometricsDissimilarStatus } from './apiVerificationCheckAnyOfThreethreeValidationsRefereeBiometricsDissimilarStatus';

export type ApiVerificationCheckAnyOfThreethreeValidationsRefereeBiometricsDissimilar = {
  status: ApiVerificationCheckAnyOfThreethreeValidationsRefereeBiometricsDissimilarStatus;
  [key: string]: unknown;
};
