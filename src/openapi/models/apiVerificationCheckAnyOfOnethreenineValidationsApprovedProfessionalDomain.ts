 ...
 */
import type { ApiVerificationCheckAnyOfOnethreenineValidationsApprovedProfessionalDomainStatus } from './apiVerificationCheckAnyOfOnethreenineValidationsApprovedProfessionalDomainStatus';

export type ApiVerificationCheckAnyOfOnethreenineValidationsApprovedProfessionalDomain = {
  status: ApiVerificationCheckAnyOfOnethreenineValidationsApprovedProfessionalDomainStatus;
  [key: string]: unknown;
};
