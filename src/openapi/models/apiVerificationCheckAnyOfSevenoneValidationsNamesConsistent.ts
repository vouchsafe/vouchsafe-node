 ...
 */
import type { ApiVerificationCheckAnyOfSevenoneValidationsNamesConsistentStatus } from './apiVerificationCheckAnyOfSevenoneValidationsNamesConsistentStatus';

export type ApiVerificationCheckAnyOfSevenoneValidationsNamesConsistent = {
  status: ApiVerificationCheckAnyOfSevenoneValidationsNamesConsistentStatus;
  [key: string]: unknown;
};
