 ...
 */
import type { YoungScotValidationApiFaceMatchStatus } from './youngScotValidationApiFaceMatchStatus';

/**
 * Whether the photo ID face matches the video selfie (with score).
 */
export type YoungScotValidationApiFaceMatch = {
  /** @nullable */
  score: number | null;
  status: YoungScotValidationApiFaceMatchStatus;
};
