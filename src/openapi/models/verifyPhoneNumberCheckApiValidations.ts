 ...
 */
import type { VerifyPhoneNumberCheckApiValidationsPhoneVerified } from './verifyPhoneNumberCheckApiValidationsPhoneVerified';

/**
 * Validations performed on the phone number.
 */
export type VerifyPhoneNumberCheckApiValidations = {
  /** Present only when the phone number has been verified.
Otherwise undefined. */
  phone_verified?: VerifyPhoneNumberCheckApiValidationsPhoneVerified;
};
