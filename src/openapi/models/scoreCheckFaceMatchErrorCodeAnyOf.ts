 ...
 */
import type { ScoreCheckFaceMatchErrorCodeAnyOfStatus } from './scoreCheckFaceMatchErrorCodeAnyOfStatus';

export type ScoreCheckFaceMatchErrorCodeAnyOf = {
  score: number;
  status: ScoreCheckFaceMatchErrorCodeAnyOfStatus;
};
