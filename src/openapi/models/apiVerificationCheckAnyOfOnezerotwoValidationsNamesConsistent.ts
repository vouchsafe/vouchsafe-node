 ...
 */
import type { ApiVerificationCheckAnyOfOnezerotwoValidationsNamesConsistentStatus } from './apiVerificationCheckAnyOfOnezerotwoValidationsNamesConsistentStatus';

export type ApiVerificationCheckAnyOfOnezerotwoValidationsNamesConsistent = {
  status: ApiVerificationCheckAnyOfOnezerotwoValidationsNamesConsistentStatus;
  [key: string]: unknown;
};
