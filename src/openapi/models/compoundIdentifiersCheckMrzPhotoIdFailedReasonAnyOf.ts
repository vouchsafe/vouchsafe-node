 ...
 */
import type { CompoundIdentifiersCheckMrzPhotoIdFailedReasonAnyOfStatus } from './compoundIdentifiersCheckMrzPhotoIdFailedReasonAnyOfStatus';

export type CompoundIdentifiersCheckMrzPhotoIdFailedReasonAnyOf = {
  status: CompoundIdentifiersCheckMrzPhotoIdFailedReasonAnyOfStatus;
};
