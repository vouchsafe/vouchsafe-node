 ...
 */
import type { ApiVerificationCheckAnyOfOnethreenineValidationsRelationshipMinimumDurationMetStatus } from './apiVerificationCheckAnyOfOnethreenineValidationsRelationshipMinimumDurationMetStatus';

export type ApiVerificationCheckAnyOfOnethreenineValidationsRelationshipMinimumDurationMet = {
  status: ApiVerificationCheckAnyOfOnethreenineValidationsRelationshipMinimumDurationMetStatus;
  [key: string]: unknown;
};
