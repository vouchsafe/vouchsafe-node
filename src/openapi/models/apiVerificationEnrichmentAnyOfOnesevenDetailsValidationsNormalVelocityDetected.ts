 ...
 */
import type { ApiVerificationEnrichmentAnyOfOnesevenDetailsValidationsNormalVelocityDetectedStatus } from './apiVerificationEnrichmentAnyOfOnesevenDetailsValidationsNormalVelocityDetectedStatus';

export type ApiVerificationEnrichmentAnyOfOnesevenDetailsValidationsNormalVelocityDetected = {
  status: ApiVerificationEnrichmentAnyOfOnesevenDetailsValidationsNormalVelocityDetectedStatus;
  [key: string]: unknown;
};
