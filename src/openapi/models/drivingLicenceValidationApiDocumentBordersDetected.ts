 ...
 */
import type { DrivingLicenceValidationApiDocumentBordersDetectedStatus } from './drivingLicenceValidationApiDocumentBordersDetectedStatus';

/**
 * Whether the correct document dimensions were detected (with score).
 */
export type DrivingLicenceValidationApiDocumentBordersDetected = {
  /** @nullable */
  score: number | null;
  status: DrivingLicenceValidationApiDocumentBordersDetectedStatus;
};
