 ...
 */
import type { ApiVerificationCheckAnyOfOnetwooneValidationsEvisaStartedStatus } from './apiVerificationCheckAnyOfOnetwooneValidationsEvisaStartedStatus';

export type ApiVerificationCheckAnyOfOnetwooneValidationsEvisaStarted = {
  status: ApiVerificationCheckAnyOfOnetwooneValidationsEvisaStartedStatus;
  [key: string]: unknown;
};
