 ...
 */
import type { FailMrzPhotoIdFailedReasonStatus } from './failMrzPhotoIdFailedReasonStatus';
import type { MrzPhotoIdFailedReason } from './mrzPhotoIdFailedReason';

export interface FailMrzPhotoIdFailedReason {
  status: FailMrzPhotoIdFailedReasonStatus;
