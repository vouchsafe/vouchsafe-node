 ...
 */
import type { DrivingLicenceValidation } from './drivingLicenceValidation';
import type { NationalIdValidation } from './nationalIdValidation';
import type { PASSCardValidation } from './pASSCardValidation';
import type { PassportValidation } from './passportValidation';
import type { UnfamiliarPhotoIdValidation } from './unfamiliarPhotoIdValidation';

export type PhotoIdValidation = PassportValidation | NationalIdValidation | DrivingLicenceValidation | PASSCardValidation | UnfamiliarPhotoIdValidation;
