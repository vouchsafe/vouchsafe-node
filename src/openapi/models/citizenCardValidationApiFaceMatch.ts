 ...
 */
import type { CitizenCardValidationApiFaceMatchStatus } from './citizenCardValidationApiFaceMatchStatus';

/**
 * Whether the photo ID face matches the video selfie (with score).
 */
export type CitizenCardValidationApiFaceMatch = {
  /** @nullable */
  score: number | null;
  status: CitizenCardValidationApiFaceMatchStatus;
};
