 ...
 */
import type { NationalIdValidationApiFaceMatchStatus } from './nationalIdValidationApiFaceMatchStatus';

/**
 * Whether the photo ID face matches the video selfie (with score).
 */
export type NationalIdValidationApiFaceMatch = {
  /** @nullable */
  score: number | null;
  status: NationalIdValidationApiFaceMatchStatus;
};
