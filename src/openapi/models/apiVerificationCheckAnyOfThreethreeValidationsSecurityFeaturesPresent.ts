 ...
 */
import type { ApiVerificationCheckAnyOfThreethreeValidationsSecurityFeaturesPresentStatus } from './apiVerificationCheckAnyOfThreethreeValidationsSecurityFeaturesPresentStatus';

export type ApiVerificationCheckAnyOfThreethreeValidationsSecurityFeaturesPresent = {
  status: ApiVerificationCheckAnyOfThreethreeValidationsSecurityFeaturesPresentStatus;
  [key: string]: unknown;
};
