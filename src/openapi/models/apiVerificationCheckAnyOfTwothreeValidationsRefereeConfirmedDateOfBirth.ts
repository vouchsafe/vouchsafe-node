 ...
 */
import type { ApiVerificationCheckAnyOfTwothreeValidationsRefereeConfirmedDateOfBirthStatus } from './apiVerificationCheckAnyOfTwothreeValidationsRefereeConfirmedDateOfBirthStatus';

export type ApiVerificationCheckAnyOfTwothreeValidationsRefereeConfirmedDateOfBirth = {
  status: ApiVerificationCheckAnyOfTwothreeValidationsRefereeConfirmedDateOfBirthStatus;
  [key: string]: unknown;
};
