 ...
 */
import type { ApiVerificationCheckAnyOfThreethreeValidationsRefereeOver18Status } from './apiVerificationCheckAnyOfThreethreeValidationsRefereeOver18Status';

export type ApiVerificationCheckAnyOfThreethreeValidationsRefereeOver18 = {
  status: ApiVerificationCheckAnyOfThreethreeValidationsRefereeOver18Status;
  [key: string]: unknown;
};
