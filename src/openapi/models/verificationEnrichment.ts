 ...
 */
import type { AmlCheckApi } from './amlCheckApi';
import type { OfaCheckApi } from './ofaCheckApi';
import type { RadarCheckApi } from './radarCheckApi';

export type VerificationEnrichment = AmlCheckApi | OfaCheckApi | RadarCheckApi;
