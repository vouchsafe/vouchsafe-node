 ...
 */
import type { YoungScotValidationApiDocumentBordersDetectedStatus } from './youngScotValidationApiDocumentBordersDetectedStatus';

/**
 * Whether the correct document dimensions were detected (with score).
 */
export type YoungScotValidationApiDocumentBordersDetected = {
  /** @nullable */
  score: number | null;
  status: YoungScotValidationApiDocumentBordersDetectedStatus;
};
