 ...
 */
import type { RadarCheckApiDetailsValidations } from './radarCheckApiDetailsValidations';

export type RadarCheckApiDetails = {
  validations: RadarCheckApiDetailsValidations;
};
