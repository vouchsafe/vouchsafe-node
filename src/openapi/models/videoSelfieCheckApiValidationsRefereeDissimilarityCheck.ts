 ...
 */
import type { VideoSelfieCheckApiValidationsRefereeDissimilarityCheckStatus } from './videoSelfieCheckApiValidationsRefereeDissimilarityCheckStatus';

export type VideoSelfieCheckApiValidationsRefereeDissimilarityCheck = {
  /**
  ...
  status: VideoSelfieCheckApiValidationsRefereeDissimilarityCheckStatus;
};
