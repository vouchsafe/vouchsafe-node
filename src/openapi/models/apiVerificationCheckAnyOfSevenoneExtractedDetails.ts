 ...
 */
import type { ApiVerificationCheckAnyOfSevenoneExtractedDetailsDocumentCategory } from './apiVerificationCheckAnyOfSevenoneExtractedDetailsDocumentCategory';

export type ApiVerificationCheckAnyOfSevenoneExtractedDetails = {
  issuer: string;
  document_date: string;
  document_category: ApiVerificationCheckAnyOfSevenoneExtractedDetailsDocumentCategory;
  postcode?: string;
