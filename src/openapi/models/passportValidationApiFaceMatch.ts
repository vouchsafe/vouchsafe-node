 ...
 */
import type { PassportValidationApiFaceMatchStatus } from './passportValidationApiFaceMatchStatus';

/**
 * Whether the photo ID face matches the video selfie (with score).
 */
export type PassportValidationApiFaceMatch = {
  /** @nullable */
  score: number | null;
  status: PassportValidationApiFaceMatchStatus;
};
