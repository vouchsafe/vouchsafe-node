 ...
 */
import type { DrivingLicenceCountryCode } from './drivingLicenceCountryCode';

/**
 * Issuing country code, or null if unavailable.
 */
export type DrivingLicenceExtractedDetailsIssuingCountry = DrivingLicenceCountryCode | null;
