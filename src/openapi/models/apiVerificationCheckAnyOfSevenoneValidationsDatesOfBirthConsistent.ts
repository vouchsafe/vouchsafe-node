 ...
 */
import type { ApiVerificationCheckAnyOfSevenoneValidationsDatesOfBirthConsistentStatus } from './apiVerificationCheckAnyOfSevenoneValidationsDatesOfBirthConsistentStatus';

export type ApiVerificationCheckAnyOfSevenoneValidationsDatesOfBirthConsistent = {
  status: ApiVerificationCheckAnyOfSevenoneValidationsDatesOfBirthConsistentStatus;
  [key: string]: unknown;
};
