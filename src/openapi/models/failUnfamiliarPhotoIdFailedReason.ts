 ...
 */
import type { FailUnfamiliarPhotoIdFailedReasonStatus } from './failUnfamiliarPhotoIdFailedReasonStatus';
import type { UnfamiliarPhotoIdFailedReason } from './unfamiliarPhotoIdFailedReason';

export interface FailUnfamiliarPhotoIdFailedReason {
  status: FailUnfamiliarPhotoIdFailedReasonStatus;
  failed_reasons: UnfamiliarPhotoIdFailedReason[];
}
