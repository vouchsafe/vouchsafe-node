...
import type { VideoSelfieCheckApiStep } from './videoSelfieCheckApiStep';
import type { VideoSelfieCheckApiValidations } from './videoSelfieCheckApiValidations';

export interface VideoSelfieCheckApi {
  /** A video selfie submission (in progress or submitted). */
  step: VideoSelfieCheckApiStep;
  /** The overall outcome of the biometric check. */
  ...
  validations: VideoSelfieCheckApiValidations;
}
