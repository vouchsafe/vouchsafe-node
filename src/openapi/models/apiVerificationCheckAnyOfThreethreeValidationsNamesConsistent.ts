 ...
 */
import type { ApiVerificationCheckAnyOfThreethreeValidationsNamesConsistentStatus } from './apiVerificationCheckAnyOfThreethreeValidationsNamesConsistentStatus';

export type ApiVerificationCheckAnyOfThreethreeValidationsNamesConsistent = {
  status: ApiVerificationCheckAnyOfThreethreeValidationsNamesConsistentStatus;
  [key: string]: unknown;
};
