 ...
 */
import type { ApiVerificationCheckAnyOfThreethreeValidationsDatesOfBirthConsistentStatus } from './apiVerificationCheckAnyOfThreethreeValidationsDatesOfBirthConsistentStatus';

export type ApiVerificationCheckAnyOfThreethreeValidationsDatesOfBirthConsistent = {
  status: ApiVerificationCheckAnyOfThreethreeValidationsDatesOfBirthConsistentStatus;
  [key: string]: unknown;
};
