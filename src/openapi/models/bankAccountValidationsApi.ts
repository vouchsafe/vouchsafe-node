...
export interface BankAccountValidationsApi {
  /** Whether required fields were extracted from the connected account data. */
  required_fields_extracted: ValidationOutcomeApi;
  /** Whether the account has recent transactions. */
  has_recent_transactions: ValidationOutcomeApi;
  /** Whether the account balance is non zero. */
  non_zero_balance: ValidationOutcomeApi;
  /** Whether the account holder name matches other evidence. */
  names_consistent?: ValidationOutcomeApi;
  /** Whether referee's name differs from the user. */
