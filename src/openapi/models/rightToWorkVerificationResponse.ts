...
import type { RightToWorkVerificationResponseEvidenceType } from './rightToWorkVerificationResponseEvidenceType';
import type { RightToWorkVerificationResponseExtractedDetails } from './rightToWorkVerificationResponseExtractedDetails';
import type { RightToWorkVerificationResponseValidations } from './rightToWorkVerificationResponseValidations';
import type { RightToWorkVerificationResponseVerificationMethod } from './rightToWorkVerificationResponseVerificationMethod';

export interface RightToWorkVerificationResponse {
  verification_method: RightToWorkVerificationResponseVerificationMethod;
  evidence_type: RightToWorkVerificationResponseEvidenceType;
  ...
  validations: RightToWorkVerificationResponseValidations;
}
