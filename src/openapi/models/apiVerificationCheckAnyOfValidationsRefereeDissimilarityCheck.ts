 ...
 */
import type { ApiVerificationCheckAnyOfValidationsRefereeDissimilarityCheckStatus } from './apiVerificationCheckAnyOfValidationsRefereeDissimilarityCheckStatus';

export type ApiVerificationCheckAnyOfValidationsRefereeDissimilarityCheck = {
  score: number;
  status: ApiVerificationCheckAnyOfValidationsRefereeDissimilarityCheckStatus;
  [key: string]: unknown;
};
