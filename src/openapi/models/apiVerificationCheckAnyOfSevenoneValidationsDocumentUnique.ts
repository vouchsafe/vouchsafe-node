 ...
 */
import type { ApiVerificationCheckAnyOfSevenoneValidationsDocumentUniqueStatus } from './apiVerificationCheckAnyOfSevenoneValidationsDocumentUniqueStatus';

export type ApiVerificationCheckAnyOfSevenoneValidationsDocumentUnique = {
  status: ApiVerificationCheckAnyOfSevenoneValidationsDocumentUniqueStatus;
  [key: string]: unknown;
};
